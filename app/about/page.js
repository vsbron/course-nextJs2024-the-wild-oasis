...
async function Page() {
  ...
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center lg:grid-cols-1 lg:gap-y-12">
      ...
      <div className="relative aspect-square col-span-2 lg:col-span-1 lg:order-1 max-w-[600px]">
        <Image
          src="/about-2.jpg"
          fill
      ...
      <div className="col-span-3 lg:col-span-1">
        ...
        <div className="space-y-8">
          ...
          <div>
            <a
              href="/cabins"
              className="inline-block mt-4 bg-accent-500 px-8 py-5 text-primary-800 text-lg font-semibold hover:bg-accent-600 transition-all lg:mt-0"
            >
